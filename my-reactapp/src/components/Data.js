...
export default [
    [{
        title:"Crowded",
        Mild: <div style={{ background: '#f1f5fc'}}><img  src={mild}/><div >Mild</div></div>,
        Moderate: <div style={{ background: '#f1f5fc'}}><img src={moderate}/><div>Moderate</div></div>,
        Severe: <div style={{ background: '#f1f5fc'}}><img src={severe}/><div>Severe</div></div>
    }],
    [{
        title:"CrossBite",
        Mild: <div style={{ background: '#f1f5fc'}}><img  src={mild2}/><div>Mild</div></div>,
        Moderate: <div style={{ background: '#f1f5fc'}}><img src={moderate2}/><div>Moderate</div></div>,
        Severe: <div style={{ background: '#f1f5fc'}}><img src={severe2}/><div >Severe</div></div>
    }],
    [{
        title:"Spaced",
        Mild: <div style={{ background: '#f1f5fc'}}><img  src={mild3}/><div>Mild</div></div>,
        Moderate: <div style={{ background: '#f1f5fc'}}><img src={moderate3}/><div>Moderate</div></div>,
        Severe: <div style={{ background: '#f1f5fc'}}><img src={severe3}/><div>Severe</div></div>
    }],
    [{
        title:"Bite issue",
